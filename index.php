        ...
        <nav class="px-5 py-3 flex items-center justify-between gap-5 shadow-md bg-white shadow-lg fixed w-full z-50">
            ...
            <div class="hidden lg:flex items-center justify-between gap-20">
                ...
                <div class="flex gap-3">
                    <a href="#">
                        <button class="rounded-sm py-1 px-5 border border-black text-lg duration-500 hover:text-white hover:bg-blue-700 hover:border-blue-500">Connexion</button>
                    </a>
                    <a href="#">
                        <button class="rounded-sm py-1 px-5 border border-blue-500 text-lg text-white bg-blue-600 duration-500 hover:bg-blue-900 hover:border-blue-900">Inscription</button>
                    </a>
                </div>
            </div>
